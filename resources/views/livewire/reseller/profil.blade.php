<div>
    @php
        ...
        $initials = collect(explode(' ', $reseller?->nama ?? ''))->take(2)->map(fn($w) => strtoupper(substr($w, 0, 1)))->implode('');
    @endphp
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <span
            ...
            <i class="fas fa-user-tag me-1"></i> Reseller
        </span>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <div class="modern-card text-center">
                ...
                <h4 style="color: var(--text-primary); font-weight: 600;">{{ $reseller?->nama }}</h4>
                <p class="text-muted mb-1">{{ $reseller?->email }}</p>
                @if($reseller?->no_hp)
                    <p class="text-muted mb-0" style="font-size: 0.9rem;"><i
                            class="fas fa-phone me-1"></i>{{ $reseller->no_hp }}</p>
                @endif
                ...
                <div class="text-start">
                    @if($reseller?->alamat)
                        <div class="mb-3">
                            ...
                            <span style="color: var(--text-primary); font-size: 0.9rem;">{{ $reseller->alamat }}</span>
                        </div>
                    @endif
                    <div class="d-flex justify-content-between mb-2">
                        <span class="text-muted" style="font-size: 0.85rem;">Bergabung</span>
                        <span
                            style="color: var(--text-primary); font-size: 0.85rem;">{{ $reseller?->created_at?->format('d M Y') }}</span>
                    </div>
                    <div class="d-flex justify-content-between">
                        <span class="text-muted" style="font-size: 0.85rem;">Terakhir diperbarui</span>
                        <span
                            style="color: var(--text-primary); font-size: 0.85rem;">{{ $reseller?->updated_at?->diffForHumans() }}</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                                wire:model="alamat" placeholder="Masukkan alamat">
